...
public enum Event {
    ...
    SSL_CERTIFICATE_REFUSED, SERVER_PASS_MISMATCH, SASL_SUCCESS, SASL_LOGGED_IN,
    SASL_NICK_LOCKED, SASL_FAIL, SASL_TOO_LONG, SASL_ABORTED, SASL_ALREADY,
    SASL_LOGGED_OUT, SASL_MECHS
}
